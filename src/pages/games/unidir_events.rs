...
use unidir_events::init_bevy_app;
    ...
    view! {
        <div class="flex w-full mx-auto max-w-[1400px] p-5 items-center">
            <Frame class="border-red-500 bg-red-500/5 flex-1">
                ...
                >
                    <BevyCanvas
                        init=move || { unidir_events::init_bevy_app(text_receiver, click_event_sender) }
                        {..}
                        width=unidir_events::RENDER_WIDTH
                        height=unidir_events::RENDER_HEIGHT
                    />
                </div>
            </Frame>
